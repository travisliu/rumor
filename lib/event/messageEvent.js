...
module.exports = class MessageEvent extends Event {
  ...
  async emit() {
    let response
    try {
      response = await this.httpPost(config.event.cofactsHost, config.event.cofactsHost, {query: query, variables: {text: this.message}})
